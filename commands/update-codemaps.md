...
Create or update codemaps in `muggle-ai-teams/projects/<project-name>/codemaps/`:
...
Write a summary to `muggle-ai-teams/projects/<project-name>/codemaps/codemap-diff.txt`:
